...
export class EditItemPage {
  ...
  this.service.getVendorList().on('value', snapshot => {
   ...
   editProduct(){
    if(this.validate()){
       this.service.editRestaurantProduct(this.product.name, this.product.available, this.product.category, this.product.description, this.product.image_firebase_url, this.product.percent,this.product.price,this.product.real_price,this.product.stock,this.product.categories,this.product.image, this.product.id).then( () =>{
      		//this.navCtrl.pop();
  ...
  validate(){
    ...
    if(this.product.available == undefined || this.product.available == ''){
